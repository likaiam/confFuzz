...
static u8 count_class_lookup[256] = {0};

void memset_array(){
  count_class_lookup[0] = 0;
  count_class_lookup[1] = 1;
  count_class_lookup[2] = 2;
  count_class_lookup[3] = 4;
  memset(count_class_lookup + 4, 8, 7 - 4 + 1);
  memset(count_class_lookup + 8, 16, 15 - 8 + 1);
  memset(count_class_lookup + 16, 32, 32 - 16);
  memset(count_class_lookup + 32, 64, 128 - 32);
  memset(count_class_lookup + 128, 128, 128); 
